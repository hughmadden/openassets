...
var async        = require('async'),
    ...
    Base58Check       = require('bitcore/lib/encoding/base58check'),
...
ColoringEngine.prototype.assetIdFromBytes = function (buf) {
  var btcBuff = new Put()
      .word8(23) //TODO fix for testnet
      .put(buf);
  return Base58Check.encode(btcBuff.buffer());
}
