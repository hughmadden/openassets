...
var LEB128 = {
  ...
  **/
  encode: function (value) {
    ...
    if (typeof(value)=="string") throw new Error("Strings not supported");
    if (value<0) throw new Error("Positive Integers Only");
    if (Number(value) && value % 1 !== 0) throw new Error("Positive Integers Only");
